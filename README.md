...
- **⌃D** switches between degrees and radians. **⌃F** toggles fraction results. **√/** (or **Answers → Rationalize**) controls whether exact answers like `5/sqrt(41)` are rewritten as `5sqrt(41)/41`.
